...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-warm-900 via-warm-700 to-warm-800 px-6">

      {/* Header */}
      <div className="text-center mb-14 animate-fade-up">
        <div className="text-6xl mb-4">🌸</div>
        <h1 className="text-white text-3xl font-serif font-light tracking-wide">For Jill</h1>
        <p className="text-warm-200/70 text-sm mt-2 tracking-wider">Enter your passcode</p>
      </div>
